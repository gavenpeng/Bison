...
public class Store extends SchemaConfigured implements HeapSize {
  ...
  throws IOException {
    ...
    //defalut bytesPerChecksum size is 16 * 1024;
  ...
  throws IOException {
    ...
    //blocksize default is 64k
    StoreFile.Writer w = new StoreFile.WriterBuilder(conf, writerCacheConf,
        fs, blocksize)
            .withOutputDir(region.getTmpDir())
            .withDataBlockEncoder(dataBlockEncoder)//defalut disk and cache do not encoder,but set the datablockencoder
            .withComparator(comparator)
            .withBloomType(family.getBloomFilterType())
            .withMaxKeyCount(maxKeyCount)
            .withChecksumType(checksumType)
            .withBytesPerChecksum(bytesPerChecksum)//default is 16k;
